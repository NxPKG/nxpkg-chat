/* global io, nxpkg, moment */
// Establish a Socket.io connection
const socket = io()
// Initialize our Nxpkg client application through Socket.io
// with hooks and authentication.
const client = nxpkg()

client.configure(nxpkg.socketio(socket))
// Use localStorage to store our login token
client.configure(nxpkg.authentication())
...
<div class="card w-full max-w-sm bg-base-100 px-4 py-8 shadow-xl">
  <div class="px-4"><i alt="" class="h-32 w-32 block mx-auto i-logos-nxpkg invert"></i>
